...
public class LocationLakeFiltererTests
{
    ...
    public void Should_compile_expressions(string expression)
    {
        ...
        Should.NotThrow(() => LocationLakeFilterer.Filter(locations, [], [], [], expression, new(), new(), [], new()));
    }
    ...
    public void Should_translate_named_expressions()
    {
        ...
        Should.NotThrow(() => LocationLakeFilterer.Filter(locations, [], [], [], orExpression, new(), new(), [], mapDefinition));
        Should.NotThrow(() => LocationLakeFilterer.Filter(locations, [], [], [], andExpression, new(), new(), [], mapDefinition));
    }
    ...
    public void Should_compile_parent_expressions(string expression)
    {
        ...
        Should.NotThrow(() => LocationLakeFilterer.Filter(locations, [], [], [], "", new(), new(), neighborFilters, mapDefinition));
    }
